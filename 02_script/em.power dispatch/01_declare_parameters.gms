...
*start-up parameters
    SC(i,n,t)                          start-up costs [EUR per MW] (are computed within the model)
...
*NTC/Trade parameters
    ...
    physical_transfer(t,n)              physical flows from_to countries whcih are not included in the model
...
$onecho > Import_general.txt
    ...
    par=priceup        rng=prices!N2:X4100          rdim=3 cdim=1
...
$onecho > Import_yearly.txt
    ...
    par=physical_transfer   rng=Import_Export!B1        rdim=1 cdim=1
...
* ------------   Loading Parameters     ---------------------
    ...
    CHP_gen_gas_cluster(gas,'DE',t)$cap_gas('DE',t)     = 0.9 * CHP_gen_gas('DE',t) * cap(gas,'DE',t) / cap_gas('DE',t) ;
    CHP_gen_gas_cluster(gas,'PL',t)$cap_gas('PL',t)     = 0.5 * CHP_gen_gas('PL',t) * cap(gas,'PL',t) / cap_gas('PL',t);
    CHP_gen_lig_cluster(lignite,'PL',t)$cap_gas('PL',t) = 0.45 * CHP_gen_lig('PL',t) * cap(lignite,'PL',t) / cap_lig('PL',t);
    CHP_gen_lig_cluster(lignite,'SI',t)$cap_gas('SI',t) = 0.9 * CHP_gen_lig('SI',t) * cap(lignite,'SI',t) / cap_lig('SI',t);
